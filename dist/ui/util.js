...
const arduinoCliExec = (command) => (0, exports.promiseExec)(`${path.normalize(config_1.arduinoCliPath)} ${command}`);
...
const isLatestCore = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return !!(list.replace(/ +/g, "@").match(config_1.core));
});
...
const isLatestOpniz = (repo) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const latestVersion = (yield (yield (0, zx_1.fetch)(githubApiUrl)).json())[0].name;
